...
public class PDFARender extends PageDeviceRender
{
	...
	protected PDFAPageDevice currentPageDevice = null;

	protected HashSet<String> bookmarks = new HashSet<String>( );

	public PDFARender( IEmitterServices services ) throws EngineException
	{
		initialize( services );
	}
	...
	{
		currentPageDevice = new PDFAPageDevice( output, title, author, subject,
	...
	{
		super.newPage( page );
		currentPage = (PDFAPage) pageGraphic;
	}
	...
	public void setTotalPage( ITextArea totalPage )
	{
		...
		isTotalPage = true;
		HashMap<Float, PdfTemplate> map = ( (PDFAPageDevice) pageDevice )
				.getTemplateMap( );
		if ( !map.isEmpty( ) )
		{
