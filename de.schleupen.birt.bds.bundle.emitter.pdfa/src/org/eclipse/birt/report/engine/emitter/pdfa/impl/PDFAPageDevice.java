...
public class PDFAPageDevice implements IPageDevice
{
	...
	protected static Logger logger = Logger.getLogger( PDFAPageDevice.class
			.getName( ) );

	protected PDFAPage currentPage = null;
	...
	public PDFAPageDevice( OutputStream output, String title, String author,
	 ...
	 * @param output
	 */
	public PDFAPageDevice( OutputStream output )
	{
		doc = new Document( );
		try
		{
	...
	protected PDFAPage createPDFPage( int pageWidth, int pageHeight )
	{
		return new PDFAPage( pageWidth, pageHeight, doc, writer, this );
	}
	...
	public void createTOC( Set<String> bookmarks )
	{
		...
		else
		{
			...
			else
			{
				...
				TOCPDFAHandler tocHandler = new TOCPDFAHandler( rootNode, writer
	...
	protected TOCPDFAHandler createTOCHandler( TOCNode root, PdfOutline outline,
			Set<String> bookmarks )
	{
		return new TOCPDFAHandler( root, outline, bookmarks );
	}
}
